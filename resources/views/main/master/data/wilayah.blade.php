        ...
        <div class="modal-body">
          <form method="POST" action="/dashboard/master-data/role/add" id="formData" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <select id="provinceSelect" name="province_id" required class="select2 w-100 @error('province_id') is-invalid @enderror">
                ...
                <div class="form-group mb-2">
                    ...
                    <select id="citySelect" name="city_id" required class="select2 w-100 @error('city_id') is-invalid @enderror">
                        <option value="" selected>&nbsp;</option>
                ...
                <div class="form-group mb-2">
                    <label for="villageSelect" class="mb-0 required">Village</label>
                    <select name="village_id" id="villageSelect" required class="select2 w-100 @error('village_id') is-invalid @enderror">
                        <option value="" selected>&nbsp;</option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control  @error('rw') is-invalid @enderror" id="rw" name="rw">
                            @error('rw')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                $villageSelect.select2({
                    ...
                    ajax:{
                        ...
                        processResults:function(data){
                            return {
                                results: $.map(data,function(obj){
                                    return {id:obj.id,text:obj.village_name}
                                })
                            };
                        }
                    },
