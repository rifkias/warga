...
@section('content')
    <nav class="page-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Organisation Type</li>
        </ol>
  </nav>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="/dashboard/config/organisation-type/add" id="formData">
            @csrf
...
@push('custom-scripts')
<script>
        var link = '/dashboard/config/organisation-type';
        var aTable;
